...
import org.cerion.tasklist.data.GoogleTasksAPI.APIException;

public class GoogleTasksSource
{
    private static final String TAG = GoogleTasksSource.class.getSimpleName();
    ...
    public final GoogleTasksAPI.Tasklists taskLists;
    public final GoogleTasksAPI.Tasks tasks;


    public GoogleTasksSource(String authKey)
    {
    ...
    public static class TaskLists implements GoogleTasksAPI.Tasklists {
        private GoogleTasksSource parent = null;
        private TaskLists(GoogleTasksSource api)
        {
            parent = api;
        }
    ...
    private JSONObject getJSON(String sURL, JSONObject requestBody, int method) throws GoogleTasksAPI.APIException {
